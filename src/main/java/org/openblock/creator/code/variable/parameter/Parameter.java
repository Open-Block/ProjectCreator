...
public class Parameter implements IVariable {
	...
	public Parameter(VariableBuilder<?> builder) {
		this.isFinal = builder.isFinal();
		this.name = builder.getName();
		this.returnType = (StatedReturnType) builder.getReturnType();
	}
	...
	@Override
	public @NotNull ParameterBuilder toBuilder() {
		return new ParameterBuilder().setReturnType(this.returnType).setName(this.name).setFinal(this.isFinal);
	}
